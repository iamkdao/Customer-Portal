        ...
        <div className="flex flex-col justify-start items-start bg-gray-200 w-full p-6 md:p-14">
            ...
            <div className="flex mt-7 flex-col items-end w-full space-y-6">
                <div className="grid grid-cols-3 w-full items-end">
                    ...
                    <p className="text-sm leading-4 text-gray-600 justify-self-start">{squareFootage} sq ft.</p>
                ...
                <div className="grid grid-cols-3 w-full items-center">
                    ...
                    <p className="text-sm leading-4 text-gray-600 justify-self-start">{commuteTime} hour{commuteTime !== '1' ? 's' : ''}</p>
